...
//		{
//			return "[ callpropvoid name:" + $abcFile.getMultinameByIndex(index) + " arg_count:" + arg_count + " ]";
//		}
		
		override protected function stringBody():String
		{
			return "name:mn(" + index + ") arg_count:" + arg_count;
//			return "name:" + $abcFile.getMultinameByIndex(index) + " arg_count:" + arg_count;
		}
		
		override public function getParams():Vector.<int>
		{
			return new <int>[index, arg_count];
		}
		
		override public function getParamNames():Vector.<String>
		{
			return new <String>["index", "arg_count"];
		}
		
		override protected function paramsToXML(xml:SWFXML):void
		{
			xml.appendChild("<index>" + index + "</index>");
			xml.appendChild("<arg_count>" + arg_count + "</arg_count>");
		}
		...
		{
			return -(1 + _arg_count + $abcFile.getMultinameByIndex(_index).needNumParams());
		}
	}
}